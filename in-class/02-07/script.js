...
// setInterval(loadData, 1000); //calls loadData once every 1000 milliseconds
...
d3.csv("datasets/cities-sm.csv").then(function(data){
    ...
    // The map contains 4 keys: one for each city. The value associated
    // with each key is an array containing all data points for that city.
